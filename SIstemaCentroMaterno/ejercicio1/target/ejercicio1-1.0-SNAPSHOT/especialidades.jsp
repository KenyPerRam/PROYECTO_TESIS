...
<html lang="es">
    <head>
        ...
        <style>
            ...
            .background {
                ...
                background-color: #f8f9fa;
                color: #495057;
                background-image: url('https://images.ecestaticos.com/KQ0t-U5lgBBaR_3L6jcUcaTdLpk=/2x111:2119x1301/1200x675/filters:fill(white):format(jpg)/f.elconfidencial.com%2Foriginal%2F3eb%2Fac0%2Fd0a%2F3ebac0d0a7d931b1e68a11decaceb700.jpg'); /* Ruta a tu imagen de fondo */
    ...
    <body  class="background">
        ...
        <div class="jumbotron jumbotron-fluid text-center">
            <div class="container">
                <h1 class="display-4">Modulo de especialidades en atención</h1>
                <p class="lead">En esta sección podremos ver todas las especialidades en las cuales los pacientes pueden tratarse a lo largo del día.</p>
            </div>
        </div>

        <div class="container especialidades-section">
            <div class="row">
                <% Controllers.DaoEspecialidades daoEspecialidades = new Controllers.DaoEspecialidades();
            ArrayList<Modelos.Especialidad> especialidades = daoEspecialidades.MostrarEspecialidades();
            for (Modelos.Especialidad especialidad : especialidades) {%>
                <div class="col-md-4 mb-4">
                    <div class="card especialidad-card">
                        <div class="card-img-top especialidad-img"
                             style="background-image: url('https://www.centroquirurgicosanrafael.com.mx/wp-content/uploads/2021/02/Icono-especialidades-medicas.png');
                             background-size: contain; /* Ajusta el tamaño para contener la imagen */
                             background-repeat: no-repeat;
                             background-position: center center;
                             padding-top: 100%; /* Relación de aspecto para mantener la altura */
                             ">
                        </div>
                        <div class="card-body especialidad-card-body text-center">
                            <h5 class="card-title"><%= especialidad.getNombre_especialidad()%></h5>
                            <p class="card-text"><%= especialidad.getDescripcion()%></p>
                        </div>
                    </div>
                </div>
                <% }%>

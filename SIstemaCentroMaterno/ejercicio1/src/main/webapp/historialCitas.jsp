...
<html lang="es">
    <head>
        ...
        <style>
            ...
            .background {
                ...
                background-color: #f8f9fa;
                color: #495057;
                background-image: url('https://previews.123rf.com/images/tommisch/tommisch1802/tommisch180200765/95766635-estetoscopio-p%C3%ADldoras-tableta-en-el-fondo-blanco-concepto-de-medicina.jpg'); /* Ruta a tu imagen de fondo */
            ...
            .custom-select-light-gray {
                background-color: #f2f2f2; /* Color de fondo */
                color: #555; /* Color del texto */
                border-color: #ccc; /* Color del borde */
            }

            /* Estilos para los bordes y sombras */
            .custom-border {
    ...
    <body  class="background">
        ...
        <div class="jumbotron jumbotron-fluid text-center">
            <div class="container">
                <h1 class="display-4">Modulo de historial de citas medicas</h1>
                <p class="lead">En esta sección podras ver el historial de todas las citas medicas que haz realizado..</p>
            </div>
        </div>
        ...
        <div class="search-container" style="display: flex; justify-content: center;">
            <form action="/ejercicio1/ControllerHistorialPaciente" method="post" style="text-align: center;">
                <!-- Combo de estado -->
                <select class="form-control mr-2 custom-select-light-gray custom-border custom-shadow" name="filtro" style="width: 150px;">
                    <option value=""></option>
                    <option value="pendiente">Pendiente</option>
                    <option value="atendido">Atendido</option>
                </select>
                <!-- Cuadro de búsqueda -->
                <input class="form-control mr-2 custom-border custom-shadow" type="search" name="cuadroBus" placeholder="Especialidad / Médico" aria-label="Buscar" style="width: 300px;">
                <!-- Botón de búsqueda -->
                <button class="btn btn-success btn-search custom-border custom-shadow" type="submit">Buscar</button>
            </form>
        </div>
        ...
        <div class="table-container" style="text-align: center;">
            <table id="historialCitasTable" class="table table-striped" style="width: 80%; margin: auto;">
        ...
        <div class="text-center" style="margin-top: 30px;">
            <a href="MenuPrincipal.jsp" class="btn btn-primary btn-go-to-menu">Volver al Menú</a>
        </div>
